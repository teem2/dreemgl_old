...
define.class(function(require, exports, self){
	...
	self.atError = function(message, where){
	...
	self.atText = function(value, start){
	...
	self.atComment = function(value, start, end){
	...
	self.atCDATA = function(value, start, end){
	...
	self.atProcess = function(value, start, end){
	...
	self.atTagBegin = function(name, start, end){
	...
	self.atTagEnd = function(start, end){
	...
	self.atClosingTag = function(name, start, end){
		this.last_attr = undefined
	...
	self.atAttrValue = function(val, start, end){
