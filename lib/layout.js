...
/*
	...
	function fillNodes(node, nochildren) {
		var newnode = {children:[], layout:{width:undefined, height:undefined, top:0, left:0, right:0, bottom:0}, style:{}}
		...
		if (node.sizetocontent) style.measure = node.sizetocontent.bind(node);
...
//					console.log("Computing layout of this child:")
		...
		if(nochildren){
			//newnode.children.push({children:[],layout:{flex:1,width:undefined, height:undefined, top:0, left:0, right:0, bottom:0},style:{width:100,height:100}})
		}
...
*/
	...
	function getLeadingMargin(node, axis) {
		...
		if(axis === 'row') return style.marginLeft >=0? style.marginLeft: style.margin >= 0? style.margin: 0
		if(axis === 'column') return style.marginTop >=0? style.marginTop: style.margin >=0? style.margin: 0
		throw new Error('implement other axes')
	}

	function getTrailingMargin(node, axis) {
		var style = node.style
		if(axis === 'row') return style.marginRight >=0? style.marginRight: style.margin >= 0? style.margin: 0
		if(axis === 'column') return style.marginBottom >=0? style.marginBottom: style.margin >=0? style.margin: 0
		throw new Error('implement other axes')
	}
	...
	function getLeadingPadding(node, axis) {
		var style = node.style
		if(axis === 'row') return style.paddingLeft >=0? style.paddingLeft: style.padding >= 0? style.padding: 0
		if(axis === 'column') return style.paddingTop >=0? style.paddingTop: style.padding >=0? style.padding: 0
		throw new Error('implement other axes')
	}
	...
	function getLeadingBorder(node, axis) {
		var style = node.style
		if(axis === 'row') return style.borderLeftWidth >=0? style.borderLeftWidth: style.borderWidth >= 0? style.borderWidth: 0
		if(axis === 'column') return  style.borderTopWidth >=0? style.borderTopWidth: style.borderWidth >= 0? style.borderWidth: 0
		throw new Error('implement other axes')
	}

	function getTrailingBorder(node, axis) {
		var style = node.style
		if(axis === 'row') return style.borderRightWidth >=0? style.borderRightWidth: style.border >= 0? style.border: 0
		if(axis === 'column') return  style.borderBottomWidth >=0? style.borderBottomWidth: style.border >= 0? style.border: 0
		throw new Error('implement other axes')
	}
	...
	function getLeadingPaddingAndBorder(node, axis) {
		var style = node.style
		if(axis === 'row') return (style.paddingLeft >=0? style.paddingLeft: style.padding >= 0? style.padding: 0) + 
		                           (style.borderLeftWidth >=0? style.borderLeftWidth: style.borderWidth >= 0? style.borderWidth: 0) 
		if(axis === 'column') return (style.paddingTop >=0? style.paddingTop: style.padding >= 0? style.padding: 0) + 
		                             (style.borderTopWidth >=0? style.borderTopWidth: style.borderWidth >= 0? style.borderWidth: 0)
		throw new Error('implement other axes')
	}

	function getTrailingPaddingAndBorder(node, axis) {
		var style = node.style
		if(axis === 'row') return (style.paddingRight >0? style.paddingRight: style.padding >= 0? style.padding: 0) +
		                           (style.borderRightWidth >=0? style.borderRightWidth: style.border >= 0? style.border: 0)
		if(axis === 'column') return (style.paddingBottom >0? style.paddingBottom: style.padding >= 0? style.padding: 0) +
		                             (style.borderBottomWidth >=0? style.borderBottomWidth: style.border >= 0? style.border: 0)
		throw new Error('implement other axes')
	}
	...
	function getMarginAxis(node, axis) {
		var style = node.style
		if(axis === 'row') return (style.marginLeft >=0? style.marginLeft: style.margin >= 0? style.margin: 0) +
		                           (style.marginRight >=0? style.marginRight: style.margin >= 0 ? style.margin: 0)
		if(axis === 'column') return  (style.marginTop >=0? style.marginTop: style.margin >= 0? style.margin: 0) +
		                              (style.marginBottom >=0? style.marginBottom: style.margin >= 0? style.margin: 0)
		throw new Error('implement other axes')
	}
	...
	function getPaddingAndBorderAxis(node, axis) {
		...
		var style = node.style
		if(axis === 'row'){
			return (style.paddingLeft >=0? style.paddingLeft: style.padding >= 0? style.padding: 0) + 
				(style.borderLeftWidth >=0? style.borderLeftWidth: style.borderWidth >0? style.borderWidth: 0) +
				(style.paddingRight >0? style.paddingRight: style.padding >0? style.padding: 0) +
				(style.borderRightWidth >=0? style.borderRightWidth: style.border >0? style.border: 0)
		}
		else if(axis === 'column') {
			return (style.paddingTop >=0? style.paddingTop: style.padding >= 0? style.padding: 0) + 
				(style.borderTopWidth >=0? style.borderTopWidth: style.borderWidth >0? style.borderWidth: 0) +
				(style.paddingBottom >0? style.paddingBottom: style.padding >0? style.padding: 0) +
				(style.borderBottomWidth >=0? style.borderBottomWidth: style.border >0? style.border: 0)
		}
		throw new Error('implement other axes')
	}
...
//			  console.log("axis" , crossAxis, "should stretch!");
			...
			//  console.log("boundaxis: ", BA, node.layout);
				child.layout[dim[crossAxis]] = fmaxf( BA,
	...
	function layoutNode(node, parentMaxWidth, /*css_direction_t*/parentDirection) {
		...
		layout.left = Math.round(layout.left)
		layout.top = Math.round(layout.top)
		...
		if(node._listen_postLayout || node.onpostLayout) node.emit('postLayout')
