...
//			  console.log("axis" , crossAxis, "should stretch!");
	...
	function layoutNode(node, parentMaxWidth, /*css_direction_t*/parentDirection) {
		...
		layout._width = layout.width = Math.round(layout.width)
		layout.height = Math.round(layout.height)
		layout.right = Math.round(layout.right)
		layout.bottom = Math.round(layout.bottom)
		Object.defineProperty(layout, 'width', {get:function(){
			return this._width
		},
		set:function(){
			debugger
